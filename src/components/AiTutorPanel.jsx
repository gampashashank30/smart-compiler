            ...
            {filteredTopics.length === 0 ? (
              ...
              filteredTopics.map(topic => {
                ...
                return (
                  ...
                  >
                    <span className={styles.topicIcon} style={{ color: lvlColor }}>
          ...
          <div className={styles.mainHeader}>
            <div className={styles.headerLeft}>
              ...
              <h1 className={styles.headerTitle}>
                <span className={styles.headerIcon} style={{ color: TUTOR_LEVELS[currentTopic.levelNum]?.color || '#6366f1' }}>
                    ...
                    return (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                        <div className={styles.card} style={{ textAlign: 'center', padding: '36px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
                          <div style={{ display: 'flex', justifyContent: 'center', animation: 'bounce 1.5s infinite' }}>
                            {score === total ? (
                              <svg width="48" height="48" viewBox="0 0 24 24" fill="#eab308" stroke="#eab308">
                                <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                              </svg>
                            ) : score >= total * 0.6 ? (
                              <svg width="48" height="48" viewBox="0 0 24 24" fill="#3b82f6" stroke="#3b82f6">
                                <path d="M12 2L2 12l10 10 10-10L12 2z"></path>
                              </svg>
                            ) : (
                              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="3">
                ...
                <div className={styles.card}>
                  ...
                  {langWarning && (
                    <div style={{
                      ...
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ea580c" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: '2px' }}>
                ...
                {aiSolution && (
                  <div className={styles.card} style={{ border: '1.5px solid #a78bfa', background: 'linear-gradient(135deg, #faf5ff 0%, #f5f3ff 100%)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
                      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#7c3aed" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
                        <rect x="3" y="11" width="18" height="10" rx="2" />
                        <circle cx="12" cy="5" r="2" />
                        <path d="M12 7v4" />
                        <line x1="8" y1="16" x2="8" y2="16" />
          ...
          {showCompletionModal && (
            <div className={styles.completionOverlay}>
              <div className={styles.completionCard}>
                <div className={styles.completionEmoji} style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
                  <svg width="64" height="64" viewBox="0 0 24 24" fill="#eab308" stroke="#eab308" style={{ animation: 'bounce 1.5s infinite' }}>
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </div>
